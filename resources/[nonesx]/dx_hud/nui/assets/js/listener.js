...
window.onload = event => {
  ...
  window.addEventListener('message', function (event) {
    ...
    if (action == 'setHealth') {
      ...
      Circle.HealthIndicator.path.setAttribute('stroke', health ? 'rgb(0, 255, 40)' : 'rgb(255, 0, 0)');
    ...
    if (action == 'setOxygen') {
      if (data) {
        ...
        Circle.OxygenIndicator.path.setAttribute('stroke', oxygen < 0.3 ? 'rgb(255, 0, 0)' : 'rgb(0, 140, 255)');
