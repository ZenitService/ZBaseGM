...
Citizen.CreateThread(function()
	...
	function enter()
		if ESX.UI.Menu.GetOpenedMenus()[1] ~= nil then
			SendNUIMessage({
	...
	function top()
		if ESX.UI.Menu.GetOpenedMenus()[1] ~= nil then
			--print(ESX.UI.Menu.GetOpenedMenus()[1])
			SendNUIMessage({
				action  = 'controlPressed',
				control = 'TOP'
			})
	...
	RegisterKeyMapping('enter+', 'Enter', 'keyboard', 'RETURN')
	RegisterKeyMapping('down+', 'Down', 'keyboard', 'DOWN')
	RegisterKeyMapping('top+', 'Top', 'keyboard', 'UP')
	RegisterKeyMapping('backspace+', 'Backspace', 'keyboard', 'BACK')
	RegisterKeyMapping('left+', 'Left', 'keyboard', 'LEFT')
	RegisterKeyMapping('right+', 'Right', 'keyboard', 'RIGHT')
